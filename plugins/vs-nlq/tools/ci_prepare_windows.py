...
def prepare_vapoursynth(deps: Path) -> Path:
    ...
    marker = out / "vapoursynth" / "libvapoursynth.dll"
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(description="Prepare VapourSynth R77 wheel files for Windows smoke tests.")
