...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(description="Smoke-test an installed vapoursynth-fft3dfilter wheel.")
    ...
    if not hasattr(core, PLUGIN_NAME) or not hasattr(core.fft3dfilter, "FFT3DFilter"):
        print("core.fft3dfilter.FFT3DFilter missing after installed-wheel autoload", file=sys.stderr)
        return 1
