...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(description="Create a release zip for a packaged Retinex plugin directory.")
    parser.add_argument("--input-dir", required=True, help="Directory containing the top-level retinex package directory.")
