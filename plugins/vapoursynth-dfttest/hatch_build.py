...
def _default_prebuilt_url(version: str) -> str:
    ...
    tag = os.environ.get("DFTTEST_PREBUILT_TAG") or f"vapoursynth-dfttest-v{version}"
...
class CustomHook(BuildHookInterface[Any]):
    ...
    def initialize(self, version: str, build_data: dict[str, Any]) -> None:
        del version
        if _platform_payload() is None:
            raise RuntimeError("vapoursynth-dfttest wheels support only Windows and Linux x86_64")
