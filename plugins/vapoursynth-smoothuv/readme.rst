...
Recommended install from the package index
------------------------------------------
...
::
    ...
    pip install --extra-index-url https://aliceteaparty.github.io/vapoursynth-api4-wheels/simple/ vapoursynth-smoothuv
...
prebuilt Release asset for the current package version tag, such as
``vapoursynth-smoothuv-v3.1``:
...
::
    ...
    pip install https://github.com/AliceTeaParty/vapoursynth-api4-wheels/releases/download/vapoursynth-smoothuv-v3.1/vapoursynth_smoothuv-3.1-py3-none-win_amd64.whl
...
::
    ...
    pip install https://github.com/AliceTeaParty/vapoursynth-api4-wheels/releases/download/vapoursynth-smoothuv-v3.1/vapoursynth_smoothuv-3.1-py3-none-manylinux_2_27_x86_64.whl
...
- ``SMOOTHUV_PREBUILT_TAG=vapoursynth-smoothuv-v3.1``
...
::
    ...
    pip install "vapoursynth-smoothuv @ git+https://github.com/AliceTeaParty/vapoursynth-api4-wheels.git#subdirectory=plugins/vapoursynth-smoothuv"

Point at a specific prebuilt archive in PowerShell:

::

    $env:SMOOTHUV_PREBUILT_URL = 'https://github.com/AliceTeaParty/vapoursynth-api4-wheels/releases/download/vapoursynth-smoothuv-v3.1/smoothuv-msys2-ucrt64.zip'
    pip install "vapoursynth-smoothuv @ git+https://github.com/AliceTeaParty/vapoursynth-api4-wheels.git#subdirectory=plugins/vapoursynth-smoothuv"

On Linux x86_64, the hook chooses ``smoothuv-linux-x86_64.zip`` first. Set
``SMOOTHUV_FORCE_BUILD=1`` to invoke the native Meson fallback. Install a C++
compiler and ``pkg-config``; the installed
...
::
    ...
    SMOOTHUV_FORCE_BUILD=1 pip install "vapoursynth-smoothuv @ git+https://github.com/AliceTeaParty/vapoursynth-api4-wheels.git#subdirectory=plugins/vapoursynth-smoothuv"

macOS, ARM, and other platforms are unsupported. Do not disable pip build
isolation for a normal source install; the build dependency above provides the
R79 SDK inside that isolated environment.
